...
const SECTIONS = [
  ...
  },
  {
    ...
    workflow: [
      ...
      "Accommodation — every arrival/departure in a date range with room price, receipt numbers, and reservation credit amounts. Its Notes section combines both Special Requests and each stay's own Notes list. Uses each reservation's *scheduled* check_in/check_out — the operational \"who's due in/out\" view, not the actual-occupancy one below.",
